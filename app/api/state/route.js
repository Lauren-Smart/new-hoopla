...
import { getCelebrants, getTeamOKRs } from "../../../lib/employmenthero";
...
export async function GET(request) {
  ...
  const [deals, deliveries, announcements, smartZeroDeals, latestEventId, celebrants, marketing, okrs] = await Promise.all([
    getJson("deals", []),
    getJson("deliveries", []),
  ...
  return NextResponse.json({
    ...
    smartZero, gp, marketing: marketing || null, okrs,
  });
}
